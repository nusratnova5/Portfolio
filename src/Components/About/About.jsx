    ...
    return (
        <div id='about' className="text-center p-8 my-20">
            ...
            <div className="flex flex-wrap items-center mt-10 text-left">
                <div className="w-full md:w-3/5 lg:w-1/2 px-20">
                    <p className="flex items-center space-x-2 text-2xl text-accent">
                ...
                <div className="w-full md:w-2/5 lg:w-1/2 px-4 text-center md:text-left lg:pl-12">
                    <p className="sm:text-lg my-6 text-white/80">
                        <span className='text-white text-3xl font-bold'>Hello! I’m Nusrat,</span><br /> a recent Computer Science and Engineering graduate who has uncovered a profound passion for web development. Since mid-2022, I’ve been immersing myself in this dynamic field, building diverse projects and honing my skills to meet industry standards.
                        <br/> <br /> 
